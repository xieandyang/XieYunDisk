...
//const QString NICKNAME_REG  = "^[{\u4e00-\u9fa5}a-zA-Z\\d_@#-\\*]\\{3,16\\}$";
...
struct FileInfo{
    ...
    int pv;                 // 下载量
    QListWidgetItem* item;  // list widget的item
};
...
public:
    ...
    // 登录信息，写入配置文件
    void writeLoginInfo(QString user, QString pwd, bool isRemember, QString path = CONFFILE);
    ...
    // 得到服务器回复的状态码， 返回值为 "002", 或 "003"，或"004"
